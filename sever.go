...
func main() {
	...
	go func() {
		...
		fmt.Println("Add FB: https://www.facebook.com/dkhuong2x")
		for {
			if atomic.LoadInt32(&cur) < int32(maxproc-1) {
				go httpcall(site, u.Host, data, headers, ss)
			}
			if sent%10 == 0 {
				fmt.Printf("https://www.facebook.com/dkhuong2x", cur, maxproc, sent, err)
			}
			switch <-ss {
			case callExitOnErr:
			...
			case targetComplete:
				sent++
				fmt.Printf("https://www.facebook.com/dkhuong2x", cur, maxproc, sent, err)
				fmt.Println("https://www.facebook.com/dkhuong2x")
				os.Exit(0)
			}
		}
	}()
